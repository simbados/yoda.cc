...
describe("detectBunResolution", () => {
  describe("npm kind", () => {
    it('returns { kind: "npm", name, version } for a plain canonical', () => {
      assert.deepEqual(detectBunResolution("lodash@4.17.21"), {
        name: "lodash",
        kind: "npm",
        version: "4.17.21",
      });
    ...
    it('returns { kind: "npm", name, version } for a scoped canonical', () => {
      assert.deepEqual(detectBunResolution("@babel/core@7.24.0"), {
        name: "@babel/core",
        kind: "npm",
        version: "7.24.0",
      });
  ...
  describe("workspace kind", () => {
    it("detects a workspace canonical", () => {
      assert.deepEqual(detectBunResolution("my-app@workspace:packages/web"), {
        name: "my-app",
        kind: "workspace",
        spec: "workspace:packages/web",
      });
    });
  });
  ...
  describe("root kind", () => {
    it("detects a root canonical", () => {
      assert.deepEqual(detectBunResolution("my-app@root:"), {
        name: "my-app",
        kind: "root",
        spec: "root:",
      });
  ...
  describe("alias kind", () => {
    it("detects an npm-alias canonical and keeps the full spec including the inner @", () => {
      assert.deepEqual(detectBunResolution("alias@npm:real-name@1.2.3"), {
        name: "alias",
        kind: "alias",
        spec: "npm:real-name@1.2.3",
      });
    });
  });
  ...
  describe("file kind", () => {
    it("detects a file: canonical", () => {
      assert.deepEqual(detectBunResolution("local@file:./local"), {
        name: "local",
        kind: "file",
        spec: "file:./local",
      });
  ...
  describe("link kind", () => {
    it("detects a link: canonical", () => {
      assert.deepEqual(detectBunResolution("sibling@link:../sibling"), {
        name: "sibling",
        kind: "link",
        spec: "link:../sibling",
      });
  ...
  describe("github kind", () => {
    it("detects a github: canonical", () => {
      assert.deepEqual(detectBunResolution("repo@github:owner/repo#sha"), {
        name: "repo",
        kind: "github",
  ...
  describe("git kind", () => {
    it("detects a git+https canonical", () => {
      assert.deepEqual(detectBunResolution("pkg@git+https://example.com/foo.git"), {
        name: "pkg",
        kind: "git",
        spec: "git+https://example.com/foo.git",
      });
    });

    it("detects a git+ssh canonical with embedded user@host", () => {
      assert.deepEqual(detectBunResolution("pkg@git+ssh://git@github.com/foo.git#sha"), {
        name: "pkg",
        kind: "git",
        spec: "git+ssh://git@github.com/foo.git#sha",
      });
    });
  });
  ...
  describe("tarball kind", () => {
    it("detects an https:// tarball URL", () => {
      assert.deepEqual(detectBunResolution("pkg@https://example.com/p.tgz"), {
        name: "pkg",
        kind: "tarball",
    ...
    it("detects an http:// tarball URL", () => {
      assert.deepEqual(detectBunResolution("pkg@http://example.com/p.tgz"), {
        name: "pkg",
        kind: "tarball",
        spec: "http://example.com/p.tgz",
      });
    });
  });
...
describe("parseBunPackageKey", () => {
  ...
  describe("non-npm resolution kinds", () => {
    ...
    it("returns null for a git+ canonical with embedded user@host", () => {
      assert.equal(parseBunPackageKey("pkg@git+ssh://git@github.com/foo.git#sha"), null);
    });
...
describe("stripUrlHash", () => {
  it("strips the #hash suffix from a URL", () => {
    ...
    assert.equal(stripUrlHash(url), "https://registry.npmjs.org/lodash/-/lodash-4.17.21.tgz");
  });
...
describe("parseBunLock", () => {
    ...
    it("returns only one entry when a nested path key and a direct key resolve to the same name@version", () => {
      const content = JSON.stringify({
        ...
        packages: {
          "@child/dep@2.0.0": [
            "@child/dep@2.0.0",
            "https://registry.npmjs.org/@child/dep/-/@child/dep-2.0.0.tgz",
            {},
            "sha512-x",
          ],
          "@parent/pkg/@child/dep": ["@child/dep@2.0.0", "", {}, "sha512-x"],
  ...
  describe("bare scoped name key (no @version suffix) parsed via value[0]", () => {
      ...
      const content = JSON.stringify({
        ...
        packages: {
          "@babel/code-frame": [
            ...
            "https://registry.npmjs.org/@babel/code-frame/-/@babel/code-frame-7.24.7.tgz#abc",
            {},
            "sha512-x",
          ],
        },
    ...
    it("strips the #hash from the resolved URL when the key is a bare scoped name", () => {
      ...
      assert.equal(
        deps[0].resolved,
        "https://registry.npmjs.org/@babel/code-frame/-/@babel/code-frame-7.24.7.tgz",
      );
    });
    ...
    it("does not drop bare scoped name packages (no silent omission)", () => {
      const content = JSON.stringify({
        lockfileVersion: 0,
        workspaces: {
          "": { dependencies: { "@babel/code-frame": "^7.24.7", lodash: "^4.17.21" } },
        },
        packages: {
          "@babel/code-frame": [
            "@babel/code-frame@7.24.7",
  ...
  describe("mixed resolution kinds", () => {
    const mixedContent = JSON.stringify({
      ...
      packages: {
        ...
        "alias-pkg": [
          "alias-pkg@npm:underlying@1.0.0",
          "https://registry.npmjs.org/underlying/-/underlying-1.0.0.tgz",
          {},
          "sha512-bbb",
        ],
    ...
    it("does not include the file: entry", () => {
      const deps = parseBunLock(mixedContent, true);
      assert.equal(
        deps.find((d) => d.name === "local-folder"),
        undefined,
      );
    });
    ...
    it("does not include the link: entry", () => {
      const deps = parseBunLock(mixedContent, true);
      assert.equal(
        deps.find((d) => d.name === "sibling-link"),
        undefined,
      );
    });
    ...
    it("does not include the https:// tarball entry", () => {
      const deps = parseBunLock(mixedContent, true);
      assert.equal(
        deps.find((d) => d.name === "tarball-pkg"),
        undefined,
      );
    });
  });
...
describe("parseBunDangerousDeps", () => {
  ...
  describe("mixed packages", () => {
    it("returns one entry per dangerous kind alongside excluded npm/workspace/root/alias entries", () => {
      ...
      assert.ok(
        out.find((e) => e.name === "local-folder" && e.reason === "local folder reference (file:)"),
      );
      assert.ok(
        out.find((e) => e.name === "sibling-link" && e.reason === "symlinked folder (link:)"),
      );
  ...
  describe("lock file with only plain npm registry entries", () => {
    it("returns an empty array", () => {
      const content = JSON.stringify({
        lockfileVersion: 1,
        workspaces: {
          "": { name: "root-app", dependencies: { lodash: "^4.17.21", vite: "^5.1.0" } },
        },
        packages: {
          "lodash@4.17.21": [
            "lodash@4.17.21",
          ...
          "vite@5.1.0": [
            "vite@5.1.0",
            "https://registry.npmjs.org/vite/-/vite-5.1.0.tgz",
            {},
            "sha512-bbb",
          ],
        },
