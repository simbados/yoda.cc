...
describe("isPublicNpmResolved", () => {
  ...
  it("returns false for a private registry URL", () => {
    assert.equal(
      isPublicNpmResolved(
        "https://my-private-registry.example.invalid/lodash/-/lodash-4.17.21.tgz",
      ),
      false,
    );
  });
  ...
  it("returns false when URL contains registry.npmjs.org but not at the start", () => {
    assert.equal(
      isPublicNpmResolved(
        "https://mirror.example.invalid/proxy/registry.npmjs.org/lodash/-/lodash-4.17.21.tgz",
      ),
      false,
    );
  });
...
describe("partitionNpmPackages — basic partitioning", () => {
  const packages = [
    ...
    },
    {
      name: "internal",
      version: "1.0.0",
      resolved: "https://private.registry.invalid/internal/-/internal-1.0.0.tgz",
    },
    {
      name: "vite",
      version: "4.0.0",
  ...
  it("privatePkgs contains the private package with name and url", () => {
    ...
    assert.equal(
      privatePkgs[0].url,
      "https://private.registry.invalid/internal/-/internal-1.0.0.tgz",
    );
  });
...
describe("partitionNpmPackages — packages with no resolved field", () => {
  const packages = [
    ...
    { name: "bundled-dep", version: "2.0.0", resolved: undefined },
    {
      name: "private-pkg",
      version: "3.0.0",
      resolved: "https://private.invalid/pkg/-/pkg-3.0.0.tgz",
    },
  ];
    ...
    const packages = [
      {
        name: "@myorg/secret",
        version: "1.0.0",
        resolved: "https://npm.pkg.github.com/@myorg/secret/-/secret-1.0.0.tgz",
      },
    ];
    const { publicPkgs, privateCount } = partitionNpmPackages(packages);
    assert.deepEqual(publicPkgs, []);
